...
const teamMembershipSchma_js_1 = require("../common/teamMembershipSchma.js"); // 1.31 kB
exports.TagItemsSchema = v.array(v.object({
    rendered_body: v.string(),
    body: v.string(),
    coediting: v.boolean(),
    comments_count: v.number(),
    created_at: v.string(),
    group: groupSchema_js_1.groupSchema,
    id: v.string(),
